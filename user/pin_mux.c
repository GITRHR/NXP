...
void BOARD_InitPins(void)
{
    ...
    /* PORT1 PIN4 (coords: 1) is configured as PIO1_4 */
		 ...
		 const uint32_t port_down_config = (/* Pin is configured as PIO0_5 */
                                        IOCON_PIO_FUNC0 |
   ...
   // IOCON_PinMuxSet(IOCON, 1U, 7U, port1_pin7_config);
		...
		//LED
    IOCON_PinMuxSet(IOCON, 1U, 4U, port_output_config);
		IOCON_PinMuxSet(IOCON, 1U, 6U, port_output_config);
		IOCON_PinMuxSet(IOCON, 1U, 7U, port_output_config);
		
		//LCD
		IOCON_PinMuxSet(IOCON, 1U, 8U, port_output_config);
		IOCON_PinMuxSet(IOCON, 1U, 1U, port_output_config);
		IOCON_PinMuxSet(IOCON, 1U, 5U, port_output_config);
		IOCON_PinMuxSet(IOCON, 1U, 2U, port_output_config);
		IOCON_PinMuxSet(IOCON, 1U, 3U, port_output_config);
		
		//handle
		IOCON_PinMuxSet(IOCON, 0U, 15U, port_output_config);
		IOCON_PinMuxSet(IOCON, 1U, 10U, port_output_config);
		
		//key
		IOCON_PinMuxSet(IOCON, 1U, 20U, port_down_config);
		
		//heart_rate
		IOCON_PinMuxSet(IOCON, 1U, 23U, port_output_config);  //scl
		IOCON_PinMuxSet(IOCON, 0U, 18U, port_output_config);   //sda
		IOCON_PinMuxSet(IOCON, 1U, 25U, port_up_config);      //in
		
		//SIM800A
		IOCON_PinMuxSet(IOCON, 0U, 1U, port_up_config);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
